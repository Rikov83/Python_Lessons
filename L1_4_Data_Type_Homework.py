...
print(f' Метод reverse: {sentence}')
print(f' Метод slice: {sentence_slice}')
...
# Задача 3.Вводится список чисел через пробел и натуральное число n - степень.
# Нужно возвести в заданную степень n все введенные числа.
