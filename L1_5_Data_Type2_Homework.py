...
# sent1 = "Python1 is: greatt ух".lower().replace(" ", "") #чтобы не придумывать текст
sent2 = input("Введите строку 2: ").lower().replace(" ", "")
# sent2 = "taerg1 sI: nohtyp ху".lower().replace(" ", "") #чтобы не придумывать текст

a = [str(i) for i in sent1] #создаем списки из всеъ символов и сортируем оба списка
a.sort()
b = [str(y) for y in sent2]
b.sort()

# if set(sent1) == set(sent2):  # проверяем совпадают ли множества по символам
# if sent1.sort == sent2.sort:
...
if a == b:
    print(f'Эти строки являются анаграммами: {sent1} / {sent2}, {a}, {b}')
else:
    print(f'Эти строки НЕ являются анаграммами: {sent1} / {sent2}, {a}, {b}')
